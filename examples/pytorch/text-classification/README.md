...
Based on the script [`run_glue.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/text-classification/run_glue.py).
...
Based on the script [`run_glue_no_trainer.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/text-classification/run_glue_no_trainer.py).
...
Based on the script [`run_xnli.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/text-classification/run_xnli.py).
