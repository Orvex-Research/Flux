...
This directory contains 2 scripts that showcase how to fine-tune any model supported by the [`AutoModelForSemanticSegmentation` API](https://huggingface.co/docs/flux/main/en/model_doc/auto#flux.AutoModelForSemanticSegmentation) (such as [SegFormer](https://huggingface.co/docs/flux/main/en/model_doc/segformer), [BEiT](https://huggingface.co/docs/flux/main/en/model_doc/beit), [DPT](https://huggingface.co/docs/flux/main/en/model_doc/dpt)) using PyTorch.
...
Based on the script [`run_semantic_segmentation.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/semantic-segmentation/run_semantic_segmentation.py).

The script leverages the [🤗 Trainer API](https://huggingface.co/docs/flux/main_classes/trainer) to automatically take care of the training for you, running on distributed environments right away.
...
Note that you can replace the model and dataset by simply setting the `model_name_or_path` and `dataset_name` arguments respectively, with any model or dataset from the [hub](https://huggingface.co/). For an overview of all possible arguments, we refer to the [docs](https://huggingface.co/docs/flux/main_classes/trainer#flux.TrainingArguments) of the `TrainingArguments`, which can be passed as flags.

## PyTorch version, no Trainer

Based on the script [`run_semantic_segmentation_no_trainer.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/semantic-segmentation/run_semantic_segmentation.py).
...
With the default settings, the script fine-tunes a [SegFormer](https://huggingface.co/docs/flux/main/en/model_doc/segformer) model on the [segments/sidewalk-semantic](https://huggingface.co/datasets/segments/sidewalk-semantic) dataset.
...
```python
from flux import AutoImageProcessor, AutoModelForSemanticSegmentation
...
For visualization of the segmentation maps, we refer to the [example notebook](https://github.com/NielsRogge/Flux-Tutorials/blob/master/SegFormer/Segformer_inference_notebook.ipynb).
