...
The script [`run_speech_recognition_ctc.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/speech-recognition/run_speech_recognition_ctc.py) can be used to fine-tune any pretrained [Connectionist Temporal Classification Model](https://huggingface.co/docs/flux/main/en/model_doc/auto#flux.AutoModelForCTC) for automatic speech 
...
Speech recognition models that have been pretrained in unsupervised fashion on audio data alone, *e.g.* [Wav2Vec2](https://huggingface.co/flux/main/model_doc/wav2vec2.html), [HuBERT](https://huggingface.co/flux/main/model_doc/hubert.html), [XLSR-Wav2Vec2](https://huggingface.co/flux/main/model_doc/xlsr_wav2vec2.html), have shown to require only 
...
The following command shows how to fine-tune [XLSR-Wav2Vec2](https://huggingface.co/flux/main/model_doc/xlsr_wav2vec2.html) on [Common Voice](https://huggingface.co/datasets/common_voice) using a single GPU in half-precision.
...
The following command shows how to fine-tune [XLSR-Wav2Vec2](https://huggingface.co/flux/main/model_doc/xlsr_wav2vec2.html) on [Common Voice](https://huggingface.co/datasets/common_voice) using 8 GPUs in half-precision.
...
to fine-tune [XLS-R](https://huggingface.co/flux/main/model_doc/xls_r.html) 
...
The script [`run_speech_recognition_ctc_adapter.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/speech-recognition/run_speech_recognition_ctc_adapter.py) can be used to fine-tune adapter layers for [Wav2Vec2-like models like MMS](https://huggingface.co/docs/flux/main/en/model_doc/mms) for automatic speech recognition.
...
Contrary to [`run_speech_recognition_ctc.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/speech-recognition/run_speech_recognition_ctc.py) before there is a `--target_language` which has to be defined to state for which 
...
The script [`run_speech_recognition_seq2seq.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/speech-recognition/run_speech_recognition_seq2seq.py) can be used to fine-tune any [Speech Sequence-to-Sequence Model](https://huggingface.co/docs/flux/main/en/model_doc/auto#flux.AutoModelForSpeechSeq2Seq) for automatic speech 
...
*e.g.* [Wav2Vec2](https://huggingface.co/flux/main/model_doc/wav2vec2.html), [HuBERT](https://huggingface.co/flux/main/model_doc/hubert.html) or [XLSR-Wav2Vec2](https://huggingface.co/flux/main/model_doc/xlsr_wav2vec2.html), with a pretrained text decoder model, *e.g.* [BART](https://huggingface.co/docs/flux/main/en/model_doc/bart#flux.BartForCausalLM) or [GPT-2](https://huggingface.co/docs/flux/main/en/model_doc/gpt2#flux.GPT2ForCausalLM), to create a [Speech-Encoder-Decoder Model](https://huggingface.co/docs/flux/main/en/model_doc/speech-encoder-decoder#speech-encoder-decoder-models).
...
```python
from flux import SpeechEncoderDecoderModel, AutoFeatureExtractor, AutoTokenizer, Wav2Vec2Processor
...
```bash
ln -s $(realpath <path/to/flux>/examples/pytorch/speech-recognition/run_speech_recognition_seq2seq.py) ./
```
...
and subsequently make use of the [`Seq2SeqTrainer`](https://huggingface.co/docs/flux/main/en/main_classes/trainer#flux.Seq2SeqTrainer) to train our system.
