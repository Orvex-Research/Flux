...
*e.g.* [Wav2Vec2](https://huggingface.co/flux/main/model_doc/wav2vec2.html),
[HuBERT](https://huggingface.co/flux/main/model_doc/hubert.html),
[XLSR-Wav2Vec2](https://huggingface.co/flux/main/model_doc/xlsr_wav2vec2.html), have shown to require only
...
| Dataset | Pretrained Model | # flux layers | Accuracy on eval | GPU setup | Training time | Fine-tuned Model & Logs |
|---------|------------------|----------------------|------------------|-----------|---------------|--------------------------|
