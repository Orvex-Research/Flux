...
This directory contains examples for finetuning and evaluating flux on translation tasks.
...
Based on the script [`run_translation_no_trainer.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/translation/run_translation_no_trainer.py).
