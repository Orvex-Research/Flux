...
This folder contains several scripts that showcase how to fine-tune a Flux model on a question answering dataset,
like SQuAD. 

## Trainer-based scripts

The [`run_qa.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/question-answering/run_qa.py),
[`run_qa_beam_search.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/question-answering/run_qa_beam_search.py) and [`run_seq2seq_qa.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/question-answering/run_seq2seq_qa.py) leverage the 🤗 [Trainer](https://huggingface.co/flux/main_classes/trainer.html) for fine-tuning.

### Fine-tuning BERT on SQuAD1.0

The [`run_qa.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/question-answering/run_qa.py) script
...
[this table](https://huggingface.co/flux/index.html#supported-frameworks), if it doesn't you can still use the old version of the script which can be found [here](https://github.com/Orvex-Research/Flux/examples/legacy/question-answering).
...
The [`run_qa_beam_search.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/question-answering/run_qa_beam_search.py) script is only meant to fine-tune XLNet, which is a special encoder-only Flux model. The example code below fine-tunes XLNet on the SQuAD1.0 and SQuAD2.0 datasets.
...
The [`run_seq2seq_qa.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/question-answering/run_seq2seq_qa.py) script is meant for encoder-decoder (also called seq2seq) Flux models, such as T5 or BART. These
