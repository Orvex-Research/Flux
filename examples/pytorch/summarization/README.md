...
This directory contains examples for finetuning and evaluating flux on summarization  tasks.
Please tag @patil-suraj with any issues/unexpected behaviors, or send a PR!
For deprecated `bertabs` instructions, see https://github.com/Orvex-Research/Flux-research-projects/blob/main/bertabs/README.md.
For the old `finetune_trainer.py` and related utils, see [`examples/legacy/seq2seq`](https://github.com/Orvex-Research/Flux/examples/legacy/seq2seq).
...
Based on the script [`run_summarization_no_trainer.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/summarization/run_summarization_no_trainer.py).
