...
This directory contains 2 scripts that showcase how to fine-tune any model supported by the [`AutoModelForImageClassification` API](https://huggingface.co/docs/flux/main/en/model_doc/auto#flux.AutoModelForImageClassification) (such as [ViT](https://huggingface.co/docs/flux/main/en/model_doc/vit), [ConvNeXT](https://huggingface.co/docs/flux/main/en/model_doc/convnext), [ResNet](https://huggingface.co/docs/flux/main/en/model_doc/resnet), [Swin Flux](https://huggingface.co/docs/flux/main/en/model_doc/swin)...) using PyTorch. They can be used to fine-tune models on both [datasets from the hub](#using-datasets-from-hub) as well as on [your own custom data](#using-your-own-data).
...
Based on the script [`run_image_classification.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/image-classification/run_image_classification.py).
...
Here we show how to fine-tune a Vision Flux (`ViT`) on the [beans](https://huggingface.co/datasets/beans) dataset, to classify the disease type of bean leaves.
...
Based on the script [`run_image_classification_no_trainer.py`](https://github.com/Orvex-Research/Flux/examples/pytorch/image-classification/run_image_classification_no_trainer.py).
